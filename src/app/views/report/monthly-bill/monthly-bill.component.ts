...
let url = `webapi/report?date=${this.Formgroup.value.date}&token_id=${this.tokenId}&report=monthly_bill&format=${this.Formgroup.value.pdf}&from_flat=${this.Formgroup.value.from_flat}&to_flat=${this.Formgroup.value.to_flat}`
