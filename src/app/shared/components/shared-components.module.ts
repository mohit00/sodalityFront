...
const components = [
  ...
  EgretExampleViewerTemplateComponent,AppSuccessComponent
]
...
@NgModule({
  ...
  entryComponents: [AppComfirmComponent, AppLoaderComponent, BottomSheetShareComponent,AppSuccessComponent],
  exports: components
})
